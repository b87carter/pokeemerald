...
static const u8 sDoorAnimTiles_CartersLab[] = INCGFX_U8("graphics/door_anims/carters_lab.png", ".4bpp");
...
static const u8 sDoorAnimPalettes_CartersLab[] = {8, 8, 8, 8, 8, 8, 8, 8};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Petalburg_Door_CartersLab,                     DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_CartersLab, sDoorAnimPalettes_CartersLab},
