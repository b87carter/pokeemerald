...
static void CB2_SaveFailedScreen(void)
{
    ...
    default:
        ...
        LZ77UnCompVram(gCarterBagTilemap, (void *)(BG_SCREEN_ADDR(14)));
        LZ77UnCompVram(gCarterGrassTilemap, (void *)(BG_SCREEN_ADDR(15)));
        ...
        ResetTasks();
        ResetPaletteFade();
        LoadPalette(gCarterBagGrass_Pal, BG_PLTT_ID(0), 2 * PLTT_SIZE_4BPP);
