...
typedef union {
    ...
    const struct MatchCallCarter *carter;
...
static bool32 MatchCall_GetEnabled_Carter(match_call_t);
...
static mapsec_u8_t MatchCall_GetMapSec_Carter(match_call_t);
...
static bool32 MatchCall_IsRematchable_Carter(match_call_t);
...
static bool32 MatchCall_HasCheckPage_Carter(match_call_t);
...
static u32 MatchCall_GetRematchTableIdx_Carter(match_call_t);
...
static void MatchCall_GetMessage_Carter(match_call_t, u8 *);
...
static void MatchCall_GetNameAndDesc_Carter(match_call_t, const u8 **, const u8 **);
...
static const struct MatchCallCarter sProfCarterMatchCallHeader =
{
    .type = MC_TYPE_CARTER,
    .mapSec = 0,
    .flag = FLAG_ENABLE_PROF_CARTER_MATCH_CALL,
    .desc = gText_ProfCarterMatchCallDesc,
    .name = gText_ProfCarterMatchCallName
};

static const match_call_text_data_t sSusanTextScripts[] = {
    { MatchCall_Text_Susan1, ALWAYS_AVAILABLE,            NO_FLAG_TO_SET },
    { MatchCall_Text_Susan2, FLAG_DEFEATED_PETALBURG_GYM, NO_FLAG_TO_SET },
    { MatchCall_Text_Susan3, FLAG_SYS_GAME_CLEAR,         NO_FLAG_TO_SET },
    MATCH_CALL_TEXT_END
};

static const struct MatchCallStructNPC sSusanMatchCallHeader =
{
    .type = MC_TYPE_NPC,
    .mapSec = MAPSEC_LITTLEROOT_TOWN,
    .flag = FLAG_ENABLE_SUSAN_MATCH_CALL,
    .desc = gText_SusanMatchCallDesc,
    .name = gText_SusanMatchCallName,
    .textData = sSusanTextScripts
};
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_PROF_CARTER] = {.carter  = &sProfCarterMatchCallHeader},
    ...
    [MC_HEADER_SUSAN]        = {.npc    = &sSusanMatchCallHeader},
...
static bool32 (*const sMatchCall_IsRematchableFunctions[])(match_call_t) = {
    ...
    MatchCall_IsRematchable_Carter
};
...
static u32 (*const sMatchCall_GetRematchTableIdxFunctions[])(match_call_t) = {
    ...
    MatchCall_GetRematchTableIdx_Carter
};
...
static void (*const sMatchCall_GetNameAndDescFunctions[])(match_call_t, const u8 **, const u8 **) = {
    ...
    MatchCall_GetNameAndDesc_Carter
};
...
static bool32 MatchCall_GetEnabled_Carter(match_call_t matchCall)
{
    return FlagGet(matchCall.carter->flag);
}
...
static mapsec_u8_t MatchCall_GetMapSec_Carter(match_call_t matchCall)
{
    return MAPSEC_NONE;
}
...
static bool32 MatchCall_IsRematchable_Carter(match_call_t matchCall)
{
    return FALSE;
}
...
static bool32 MatchCall_HasCheckPage_Carter(match_call_t matchCall)
{
    return FALSE;
}
...
static u32 MatchCall_GetRematchTableIdx_Carter(match_call_t matchCall)
{
    return REMATCH_TABLE_ENTRIES;
}
...
static void MatchCall_GetMessage_Carter(match_call_t matchCall, u8 *dest)
{
...
static void MatchCall_GetNameAndDesc_Carter(match_call_t matchCall, const u8 **desc, const u8 **name)
{
    *desc = matchCall.carter->desc;
    *name = matchCall.carter->name;
}
